...
This associates with the analysis @sun18, which includes the panel `SomaScan160410`, as with 
the Olink qPCR inflammation panel (`inf1`)[^inf1] used in the SCALLOP consortium @zhao23.
...
Panel `seer1980` is reported in @suhre24.
