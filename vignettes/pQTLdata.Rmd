...
pkgs <- c("dplyr", "grid", "EnsDb.Hsapiens.v75", "ensembldb", "knitr", "org.Hs.eg.db", "S4Vectors", "VennDiagram")
...
This associates with the analysis of INTERVAL data as reported @sun18, which includes the panel `SomaScan160410`, supplementary tables 4, 6, 18.

# Reference data

Initial curations including `biomaRt`, `hg19` and `hg19Tables` based on ENSEMBL BioMart and UCSC are now depcrecated. Insted, we resort to `EnsDb.Hsapiens.v75` from Bioconductor.
...
knitr::kable(info,caption="Annotation for BRCA1 and TP53")
