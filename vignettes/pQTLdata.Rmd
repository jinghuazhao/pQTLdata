...
```{r overlap1, echo=FALSE, fig.cap="Overlap of Olink Explore HT, SomaLogic V4.1 and Caprion", fig.height=9, fig.width=9, messages=FALSE, results="hide"}
...
```{r overlap2, echo=FALSE, fig.cap="Overlap of Olink Explore HT, SomaLogic 11K and Caprion", fig.height=9, fig.width=9, messages=FALSE, results="hide"}
suppressMessages(library(dplyr))
suppressMessages(library(VennDiagram))
uniprot <- list(Olink=pull(pQTLdata::Olink_Explore_HT,UniProt.ID),
                Somalogic=pull(pQTLdata::SomaScan11k,UniProt.ID),
                Caprion=pull(pQTLdata::caprion,Accession))
lapply(uniprot,head)
olink_somalogic_caprion <- VennDiagram::venn.diagram(uniprot,filename = NULL,disable.logging = TRUE,
                                                     cex = 2.5, cat.cex = 2.5, cat.pos = c(0,0,180),
