...
It is of interest to compare some of these, see Figure \ref{fig:fig_osc},

```{r, echo=FALSE, fig.cap="\\label{fig:fig_osc}Overlap of Olink Explore HT, SomaLogic V4.1 and Caprion.", fig.height=9, fig.width=9, messages=FALSE, results="hide"}
