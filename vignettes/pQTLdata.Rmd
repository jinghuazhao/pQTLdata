...
It is of interest to compare some of these, see @fog_osc,

```{r, echo=FALSE, fig.height=9, fig.width=9, messages=FALSE, results="hide"}
#| label: fig_osc
#| fig-cap: "Overlap of Olink Explore HT, SomaLogic V4.1 and Caprion."
#| warning: false
