...
* **`data/`**. R datasets.
* **`inst/`**. `EndNote/`, `Olink/`, `scripts/`, which spread into the package's root directory after installation.
...
This includes Olink_qPCR for all 12 panels and Olink Explore panels.
...
(`inf1`, <https://olink.com/products/olink-target-96>) @zhao23 and Seer (`seer1980`) @suhre24. In particular,
`inf1` contains updates from the original release by Olink.
