...
```{r, echo=FALSE, fig.cap="Figure 1. Overlap of Olink Explore HT, SomaLogic V4.1 and Caprion", fig.height=9, fig.width=9, messages=FALSE}
...
lapply(uniprot,head)
olink_somalogic_caprion <- VennDiagram::venn.diagram(uniprot,filename=NULL,
